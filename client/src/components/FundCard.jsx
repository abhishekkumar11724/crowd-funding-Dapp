    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col p-4">
                ...
                <div className="block">
                    <h3 className="font-epilogue text-white font-semibold text-[16px] text-left leading-[26px] truncate">
                        {title}
                    </h3>
                ...
                <div className="flex items-center mt-[20px] gap-[12px]">
                    ...
                    <p className="flex-1 font-epilogue font-normal text-[12px] text-[#808292] truncate">
